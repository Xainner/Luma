export const es = {
  ...
  'onboarding.setupFast': 'Configura Luma en menos de un minuto.',
  ...
  'onboarding.ready': 'Luma está listo.',
  ...
  'thinking.descOff': 'Prioriza velocidad y respuesta directa.',
  ...
  'settings.reasoning.advancedBody':
    'Luma adapta los niveles (Off/Bajo/Medio/Alto) al formato que soporta el backend actual. Hoy el backend expone un interruptor de thinking: Off lo desactiva y el resto lo activa, reservando más tokens de salida cuanto más alto el nivel.',
  ...
  'settings.admin.statusApi': 'API Luma',
  ...
  'settings.about.body': 'Chat con tu LLM, sin censura ni ataduras.',
